...
HD_PWD='C:/Users/eleni/Documents/GitHub/TFG/Ejemplo Combinacional/ejemplo1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comb.vdi -applog -m64 -messageDb vivado.pb -mode batch -source comb.tcl -notrace
