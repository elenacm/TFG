...
HD_PWD='C:/Users/eleni/Documents/GitHub/TFG/Práctica 1/ipgenerator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_scomp.vds -m64 -mode batch -messageDb vivado.pb -notrace -source my_scomp.tcl
