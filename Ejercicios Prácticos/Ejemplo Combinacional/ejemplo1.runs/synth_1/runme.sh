...
HD_PWD='C:/Users/eleni/Desktop/project_1/ejemplo1/ejemplo1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comb.vds -m64 -mode batch -messageDb vivado.pb -notrace -source comb.tcl
