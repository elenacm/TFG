...
HD_PWD='C:/Users/eleni/Desktop/project_1/Encender1LedSwitch/Encender1LedSwitch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log encerder1led.vds -m64 -mode batch -messageDb vivado.pb -notrace -source encerder1led.tcl
