...
\newcommand{\myTitle}{Plataforma didáctica}
\newcommand{\myTitleone}{para desarrollo de sistemas}
\newcommand{\myTitletwo}{basados en FPGAs de}
\newcommand{\myTitlethree}{Xilinx}
\newcommand{\myDegree}{Grado en Ingeniería Informática\xspace}
\newcommand{\myName}{Elena Cantero Molina\xspace}
\newcommand{\myProf}{María Begoña del Pino Prieto\xspace}
...
\input{capitulos/03_MotivacionIntrosuccion}
...
\input{capitulos/07_Anexo}

\clearpage
\nocite{*}
\bibliographystyle{plain}
\addcontentsline{toc}{chapter}{\textsc{Bibliografia}}
